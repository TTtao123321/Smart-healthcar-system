...
export default {
    ...
    methods: {
      loadDoctorList: function() {
        ...
        that.$http('/doctor/selectDoctorsBySubId', 'POST', data, true, function(resp) {
      ...
      init: function(workPlanId, deptSubId, date) {
        ...
        that.$nextTick(() => {
          ...
          if (workPlanId != null) {
            ...
            that.$http('/doctor/work_plan/schedule/selectScheduleByWorkPlanId', 'POST', data, true,function(resp) {
        ...
        that.$refs['dataForm'].validate(function(valid) {
          if (valid) {
            ...
            if (that.dataForm.workPlanId == null) {
              ...
              that.$http('/doctor/work/plan/insert', 'POST', data, true, function (resp) {
              let result = resp.result;
              if (result == '添加完成') {
                ElMessage({
                  message: '操作成功',
